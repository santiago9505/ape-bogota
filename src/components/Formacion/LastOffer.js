...
const LastOffer = () => {
  return (
    <div className="bg-gray-200 rounded-sm flex flex-col gap-2 font-sena content-center text-xs py-4 mx-6 mb-4">
      ...
      <article className="flex justify-between px-4 gap-5">
        <p className="bg-green-450 rounded-sm shadow-2xl p-2 text-white pt-3">
          DEL 05 AL 11 DE MARZO DE 2021
        </p>
        <p className="text-sm text-blue-450 text-center">
