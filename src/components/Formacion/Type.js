...
const Type = () => {
  return (
    <section className="flex flex-col bg-blue-550 leading-snug text-white font-sena font-normal text-lg lg:grid lg:grid-cols-2">
      ...
      <div className="px-4 flex flex-col gap-2 tracking-tight py-8">
        ...
        <h2 className="">
          Duración:
          <p>
            Un año (Seis meses de etapa lectiva y seis meses de etapa práctica.
          </p>
        </h2>
        <h2 className="">
          Inscripciones:
      ...
      <div className="px-4 flex flex-col gap-2 py-8">
        ...
        <h2 className="">
          Duración:
          <p>
            Dos años (Un año y seis meses de etapa lectiva y seis meses de etapa
            práctica.)
          </p>
        </h2>
        <h2 className="">
      ...
      <div className="px-4 flex flex-col gap-2 py-8">
        ...
        <p>
          ...
          para inscripciones cada tres meses a través de Sena Sofía Plus
        </p>
        <button className="border-2 w-36 mx-auto rounded-lg my-2">
          Conoce más
        </button>
